...
> extends Component<TimelineProps<CustomItem, CustomGroup>, TimelineState<CustomGroup>> {
  getTimelineContext = () => {
  ...
  constructor(props: TimelineProps<CustomItem, CustomGroup>) {
    ...
    this._resizeObserver = new ResizeObserver((entries) => {
      // TODO: this could be the issue of not painting anything. might not be called..
  ...
  render() {
    ...
    return (
      <LocalizationContext.Provider value={{ locale: this.props.locale }}>
        <TimelineProvider
          canvasTimeEnd={canvasTimeEnd}
          canvasTimeStart={canvasTimeStart}
          canvasWidth={canvasWidth}
              ...
              >
                ...
                <div style={outerComponentStyle} className="rct-outer">
                  ...
                  <ScrollElement
                    ...
                    onVerticalScrollByDelta={this.scrollVerticallyBy}
                    onWheelZoom={this.handleWheelZoom}
                    onZoom={this.changeZoom}
                    onHorizontalScrollByDelta={this.scrollHorizontallyByTime}
